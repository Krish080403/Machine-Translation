...
train_df['MUNDARI1'].to_csv('wmt22/marathi_train.txt', index=False, header=False)
dev_df['MUNDARI1'].to_csv('wmt22/marathi_dev.txt', index=False, header=False)
test_df['MUNDARI1'].to_csv('wmt22/marathi_test.txt', index=False, header=False)
