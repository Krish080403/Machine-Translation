...
train_df = pd.read_excel('incorrect.xlsx')
test_df = pd.read_excel('incorrect.xlsx')
dev_df = pd.read_excel('incorrect.xlsx')
...
train_df['Correct Sentence'].to_csv('wmt22/marathi_train.txt', index=False, header=False)
dev_df['Correct Sentence'].to_csv('wmt22/marathi_dev.txt', index=False, header=False)
test_df['Correct Sentence'].to_csv('wmt22/marathi_test.txt', index=False, header=False)
